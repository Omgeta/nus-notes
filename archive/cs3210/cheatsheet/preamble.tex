...
\lstdefinestyle{mystyle}{
  ...
  morekeywords=[3]{omp_lock_t, dim3, int, char, float, double, void, struct, union, enum, const, volatile, static, extern, register, inline, restrict, _Bool, _Complex, _Imaginary, size_t, ssize_t, FILE, bool}, % C standard types and common identifiers
  keywordstyle=[3]\color{orange},
  morekeywords=[4]{printf, scanf, fopen, fclose, malloc, free, calloc, realloc, perror, strtok, strncpy, strcpy, strcmp, strlen, true, false}, % Standard library functions
  keywordstyle=[4]\color{blue},
  morekeywords=[5]{fork, join, execl, exit, wait, waitpid, dup, dup2, shmget, shmat, shmdt, shmctl, pipe, close, write, read, signal, kill, raise, pthread\_create, pthread\_exit, pthread\_join, pthread\_mutex\_lock, pthread\_mutex\_unlock, pthread\_cond\_wait, pthread\_cond\_signal, pthread\_cond\_broadcast, consume, produce, seek, lseek, open, stat, unlink, mkdir, rmdir, chdir, getcwd, link, symlink, acquire, release, omp_init_lock, omp_set_lock, omp_unset_lock, MPI_Init, MPI_Finalize, MPI_Abort, MPI_Send, MPI_Recv, MPI_Test, MPI_Wait, MPI_Barrier, MPI_Bcast, MPI_Scatter, MPI_Gather, MPI_Reduce, MPI_Allgather, MPI_Alltoall, MPI_Reduce_scatter},

...
\lstdefinestyle{mystyle}{
  ...
  stringstyle=\color{violet}, % Color for strings
  ...
  keywordstyle=[2]\color{green}, % Style for preprocessor directives
  ...
  keywordstyle=[3]\color{blue}, % Style for types and common identifiers
